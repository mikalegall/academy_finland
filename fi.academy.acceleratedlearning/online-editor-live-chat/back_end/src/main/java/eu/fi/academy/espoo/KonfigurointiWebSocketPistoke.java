...
public class KonfigurointiWebSocketPistoke extends AbstractWebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ...
        registry.addEndpoint("rekisteroidy").setAllowedOrigins("*").withSockJS();
        // Yllä oleva .setAllowedOrigins("*") mahdollistaa kutsujen lähettämisen myös muualta kuin saman toimialueen sisältä
    }
